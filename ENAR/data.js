...
const courses = [
    ...
    ['تركيز تصميم المعماري', '-------', [], `<table><tr><th>المتطلبات</th><th>المادة</th></tr>
                                                   <tr><td>ENAR4121tdtd(2)ندوة في التصميم المعماري</td></tr>
                                                   <tr><td>ENAR5311tdtd(3) العمارة المعاصرة</td></tr>
                                                    <tr><td>ENAR5411tdtd(4) تصميم معماري متقدم</td></tr>
                                                    </table>`],

    ['تركيز تصميم الداخلي', '-------', [], `<table><tr><th>المتطلبات</th><th>المادة</th></tr>
                                                  <tr><td>ENAR4101tdtd(2)ندوة في التصميم الداخلي</td></tr>
                                                    <tr><td>ENAR5321tdtd(3) نظريات التصميم الداخلي</td></tr>
                                                    <tr><td>ENAR5421tdtd(4) تصميم داخلي متقدم</td></tr>
                                                    </table>`],
    ...
    ['مشروع تخرج', 'ENAR530', ['ENAR520','ENAR5411','ENAR5421','ENAR5441']]
];
